  ...
  function onOpenControlDetected(maj_ver, min_ver) {
    ...
    statusLabel.innerHTML = "<b> Please connect open·control </b>";
        ...
        statusLabel.innerHTML = "<b> open·control detected</b> <br> <font size=2><center><a href=https://github.com/KBLiveSolutions/open.control-firmware target=_blank style=color:#000000;> new firmware available</a> <br> Current: " + maj_ver + "." + min_ver +" | New: " + LATEST_FIRMWARE_MAJOR_VERSION + "." + LATEST_FIRMWARE_MINOR_VERSION;
        }
        else {
        connect_cell.style.backgroundColor = "#00FF55";
        statusLabel.innerHTML = "<b> open·control detected</b> <br> <center><font size=2>Firmware version: " + maj_ver + "." + min_ver;
        }
  }
